function [dv_min, date_dep, date_fb, date_arr] = brute_force_validation(n) %#codegen
earl_dep_date   = [2028 01 01 00 00 00];
late_arr_date   = [2028 + 13 01 01 00 00 00];

dep_mjd2000     = linspace(date2mjd2000(earl_dep_date), date2mjd2000(late_arr_date), n);
