...
static emlrtRSInfo x_emlrtRSI = {
    ...
    "functions\\lambertMR.m" /* pathName */
};
    ...
    *THETA = 0.0;
    ...
    if ((d1 == 0.0) || (muDoubleScalarAbs(d) < 1.0E-14)) {
      ...
      *THETA = 0.0;
      ...
      st.site = &ib_emlrtRSI;
      b_st.site = &q_emlrtRSI;
      M = 1.0616995201440001E+12 * (TOF * TOF) /
      ...
      *TPAR = 1.2940108746135795E-6 * (muDoubleScalarPower(S, 1.5) -
...
/* End of code generation (lambertMR.c) */
