function plotorbit_dotted(kep, th0, thf, dth, mu, color)
...
% color. This version uses a dotted line instead of a continue one.
%
%--------------------------------------------------------------------------
%
% INPUT:
...
plot3(R(:, 1), R(:, 2), R(:, 3), '--','Color',color, 'LineWidth', 0.7)