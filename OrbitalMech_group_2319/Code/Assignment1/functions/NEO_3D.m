...
%----------------------Plot 1036 Ganymed in 3D plot------------------------
%
% This function plots a sphere with 1036 Ganymed texture in a pre-existing
% 3D space, at the coordinates expressed by r.
%
%--------------------------------------------------------------------------
%
% INPUT:
% r               [3x1]: position vector in cartesian frame, in km
% n                 [1]: scale factor for asteroid radius (default 1)
%
%--------------------------------------------------------------------------
%
